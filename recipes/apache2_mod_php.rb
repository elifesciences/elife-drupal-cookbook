...
node.default["apache"]["prefork"]["startservers"] = 3
node.default["apache"]["prefork"]["minspareservers"] = 1
node.default["apache"]["prefork"]["maxspareservers"] = 4
node.default["apache"]["prefork"]["serverlimit"] = 8
node.default["apache"]["prefork"]["maxclients"] = 8
node.default["apache"]["prefork"]["maxrequestsperchild"] = 1000

node.default["apache"]["worker"]["startservers"] = 3
...
node.normal["php5"]["resource_limits"]["memory_limit"] = "384M"
